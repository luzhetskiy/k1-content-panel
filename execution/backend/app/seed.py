...
{% endfor %}{% endif %}
Требования:
- объём около 2600 символов видимого текста (без тегов), строго от 2500 до 2900 — длиннее нельзя, это примерно 350–400 слов;
- HTML: 3–5 блоков, у каждого подзаголовок <h2>, дальше абзацы <p>, где уместно — список <ul><li>; других тегов, атрибутов, ссылок и заголовка <h1> не используй;
