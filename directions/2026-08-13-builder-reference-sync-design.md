...
Каждый шаг коммитится отдельно, сразу после своего успеха (не одной общей
транзакцией на оба шага) — так отказ одного шага не может откатить уже
успешно сохранённый результат другого, независимого шага.
